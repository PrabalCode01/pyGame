    ...
    if buttons[row][column]['text']=="" and check_winner() is False:
            ...
            if player==players[0]:
                ...
                if check_winner() is False:
                    ...
                    label.config(text="ohh! its a Tie")
                ...
                if check_winner() is False:
                    player= players[0]
                    label.config(text=("Turn of " +players[0]))
...
label2=Label(text="Welcome to Tic-Tac-Toe Game", font=('consolas',40))
label2.pack(side="top")
label2.config(bg="orange")
label= Label( text="Turn of " +player, font=('consolas',40))
label.pack(side="top")
...
for row in range(3):
    for column in range(3):
        ...
        buttons[row][column].config(bg="cyan")
